...
type DaemonApplyRequest struct {
	LabPath           string
	LibvirtURI        string
...
type DaemonController interface {
	...
	Apply(context.Context, DaemonApplyRequest) error
}
...
func newSystemdDaemonController() *systemdDaemonController {
...
func (c *systemdDaemonController) Status(ctx context.Context) (DaemonStatus, error) {
	...
	return DaemonStatus{Active: active, LabPath: path}, nil
}

func (c *systemdDaemonController) Apply(ctx context.Context, req DaemonApplyRequest) error {
...
func (c *systemdDaemonController) destroyPreviousLab(ctx context.Context, req DaemonApplyRequest, path string) error {
	if c.destroyLab != nil {
